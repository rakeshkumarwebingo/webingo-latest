...
<div class="text-l service-desc- pr25">
	...
	<h2>About WordPress Development</h2>
	<br>
<p style="text-align: justify">WordPress website comprise 20% - 30% of the Internet. It can also be a support wall for CMS systems. We can help you develop a WordPress website from scratch, or create plugins or integrate them into existing websites. WordPress has the capability to offer highly functional websites. It is also user-friendly.  </p>
...
<div class="servie-key-points">
  ...
  <h4>Benefits of WordPress Development  </h4>
  <ul class="key-points mt20">
      <li>Simple and easy to use </li>
      <li>Stable and innovative</li>
...
<h2 class="mb30" style="color:#000;">What we offer with WordPress Development?</h2>
</div>
</div>
</div>
...
<p style="color:#000;">Custom Development.</p>
...
<p style="color:#000;">WordPress Theme Based Development.</p>
<!--<a href="javascript:void(0)">Learn More <i class="fas fa-chevron-right fa-icon"></i></a>-->
</div>
...
<p style="color:#000;">E-Commerce Solutions.</p>
<!--<a href="javascript:void(0)">Learn More <i class="fas fa-chevron-right fa-icon"></i></a>-->
</div>
</div> 
<div class="col-lg-4 col-sm-6 mt30 shape-loc wow fadeInUp" data-wow-delay="0.6s" style="visibility: visible; animation-delay: 0.6s; animation-name: fadeInUp;">
...
<p style="color:#000;">API Integration.</p>
<!--<a href="javascript:void(0)">Learn More <i class="fas fa-chevron-right fa-icon"></i></a>-->
</div>
</div> 
<div class="col-lg-4 col-sm-6 mt30 shape-loc wow fadeInUp" data-wow-delay="0.6s" style="visibility: visible; animation-delay: 0.6s; animation-name: fadeInUp;">
...
<p style="color:#000;">Plugin Development.</p>
<!--<a href="javascript:void(0)">Learn More <i class="fas fa-chevron-right fa-icon"></i></a>-->
</div>
</div> 
						...
						<div class="row justify-content-center">
							<div class="col-lg-6 col-sm-6 mt30  wow fadeIn" data-wow-delay=".2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeIn;">
								<div class="s-block wide-sblock">
									...
									<div class="s-block-content">
										...
										<p>
										An expert team that follows latest trends and complex development practices.</p>
									</div>
								</div>
							</div>
							<div class="col-lg-6 col-sm-6 mt30 wow fadeIn" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeIn;">
								<div class="s-block wide-sblock">
									...
									<div class="s-block-content">
										<h4>Full-service Development</h4>
										<p>

										Designing, development and post launch maintenance, we offer full-service for your
										WordPress requirements.</p>
									</div>
								</div>
							</div>
							<div class="col-lg-6 col-sm-6 mt30 wow fadeIn" data-wow-delay=".8s" style="visibility: visible; animation-delay: 0.8s; animation-name: fadeIn;">
								<div class="s-block wide-sblock">
									...
									<div class="s-block-content">
										...
										<p>
										Serves your content across all formats including web, mobile and hybrid devices.</p>
									</div>
								</div>
							</div>
							<div class="col-lg-6 col-sm-6 mt30 wow fadeIn" data-wow-delay="1.1s" style="visibility: visible; animation-delay: 1.1s; animation-name: fadeIn;">
								<div class="s-block wide-sblock" >
									<div class="s-card-icon"><img src="images/icons/profit.png" alt="service" class="img-fluids"></div>
									<div class="s-block-content">
										<h4> Long Term Goals</h4>
										<p>
										Development with Long term functionality kept in mind.</p>
									</div>
								</div>
							</div>
          ...
          <a href="javascript:void(0)" class="btn-outline">View More Projects <i class="fas fa-chevron-right fa-icon"></i></a>
				...
				<div class="container">
					...
					<div class="col-lg-8">
						<div class="common-heading ptag">
							<span class="text-radius text-light text-animation bg-b">We Deliver Our Best</span>
							<h2>What we offer with WordPress Development</h2>
				...
				We allow direct, real-time access to your development team via Skype. You can have to get demos anytime you want. Feel free to use your project management system.</p>
					...
					<div class="media mt40">
						...
						<div class="media-body">
							<h4> WordPress Theme Based Development</h4>
							<p style="text-align:justify;">
            ...
            <div class="card-1">
              ...
              <div id="collapse-a" class="card-body collapse " aria-labelledby="faq1" data-parent="#accordion">
                <p>
					...
					WordPress is an open source content management system and blogging tool. It was released in 2003. It is currently the most popular blogging tool on the internet. WordPress is currently used by 1/5 of the top 10 million websites.</p>
              </div>
            </div>
           <div class="card-1 ">
              ...
              <div id="collapse-e" class="card-body collapse" aria-labelledby="faq5" data-parent="#accordion2">
                <p>
					...
					Templates are the files that show what will be displayed on your WordPress site.</p>
              </div>
            </div>
        ...
        <div class="col-md-6 mt60">
          <div id="accordion2" class="accordion">
              ...
              <div class="card-header" id="faq2" style="background: linear-gradient(135deg,#3F74A3,#0000AA 32%,#4D4DFF);">
                ...
                How Is WordPress Customizable?
                </button>
              </div>
              <div id="collapse-f" class="card-body collapse" aria-labelledby="faq2" data-parent="#accordion2">
                <p>
				
					WordPress allows you post your stories, ideas, rants, reviews, links, and/or pictures of anything you choose. You can customize the look and feel of your site by choosing one of WordPress’s numerous available themes, which will determine the style of your site. Different plugins also allow you to extend the functionality of your site. Here is a list of these plugins: Plugins.</p>
              </div>
            </div>
			  <div class="card-1 ">
              ...
              <div id="collapse-b" class="card-body collapse" aria-labelledby="faq4" data-parent="#accordion2">
                <p>
					...
					Yes. We complete the designing and development process in phases and after each phase we show the progress to you.</p>
              </div>
            </div>
