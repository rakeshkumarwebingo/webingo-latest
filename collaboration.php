...
<div class="container">
  <div class="row justify-content-center">
    <div class="col-lg-6 v-center">
      ...
      <h2 class="mt0 mb0">LOOKING FOR COLLABS</h2>
        <p class="mb60 mt20">“If everyone is moving forward together, then success
takes care of itself.”</p>
      ...
      <div class="form-block">
        <form id="contact-form" method="post" action="php/contact.php" data-toggle="validator">
          ...
          <div class="fieldsets row">
			  <div class="col-md-2 form-group" style="padding-right:0px"><input id="form_phone" type="text" name="phone"  placeholder="code *" required="required" data-error="country code is required.">
            <div class="help-block with-errors"></div></div>
            <div class="col-md-4 form-group"><input id="form_phone" type="text" name="phone"  placeholder=" Phone No *" required="required" data-error="Phone No is required.">
            <div class="help-block with-errors"></div></div>
           	 <div class="col-md-6 form-group"><input id="form_phone" type="text" name="company name"  placeholder="Enter your company name *" required="required" data-error="company name is required.">
            <div class="help-block with-errors"></div></div>
          </div>
      ...
      <div class="contact-details">
        ...
        <div class="email-card mt30 wow fadeIn" data-wow-delay=".5s">
          <div class="info-card v-center">
            <span class="text-radius text-light text-animation bg-b"><i class="fas fa-user"></i>collaboration </span>
            <div class="info-body">
              <p>Reasons why collaboration is important:</p>
				<p>1. It helps us problem-solve</p>
				<p>2. Collaboration bring organizations closer &amp; enhances their skills</p>
				<p>3. It opens up new channels for communication</p>
				<p>4. Collaboration boosts morale across your organization</p>
				<p>5. It leads to higher retention rates</p>
...
<div class="col-lg-6 col-sm-6 shape-loc wow fadeInUp" data-wow-delay=".2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeInUp;">
  <div class="office-card">
    <div class="skyline-img">
      <img src="images/kolkata.jpg" alt="New York" class="img-fluid">
    </div>
