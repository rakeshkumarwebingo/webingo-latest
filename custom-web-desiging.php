...
<div class="text-l service-desc- pr25">
	...
	<h2>Some Insight</h2>
	<br>
	<p style="text-align: justify"> Custom website design solutions can be the right option for clients who want high quality designs and want their website to stand out of the competition. We are a one stop destination for custom web design solutions. We would design the website as per your likings.</p>
	<p style="text-align: justify">Being an experienced and expert custom web design company, we have huge expertise in all the elements of web design including graphics, programming, animation, flash, usability and much more. We are backed up by a team of creative and skilled designers who create stunning and fruitful websites for all the projects. They have created thousands of deeply enriching, creative websites for our clients.</p>
	<p style="text-align: justify">We offer superior quality custom web designs at affordable rates. What makes us different from the other custom website design companies in India is that we never compromise on quality. We offer tailor made solutions as per your requirements and the budget.</p>
<p style="text-align: justify">If you’re looking for a professional custom website design company in India, we can help you with creative and impressive web designs. We offer clean coding and search engine friendly websites to our clients worldwide. We never use templates for custom web design in India.</p>
...
<div class="col-lg-7">
<div class="text-l service-desc- pr25">
  <h3 class="mb20" style="color:#000">Benefits of Custom Web Design </h3>  
  <p style="text-align: justify"><strong>Adaptability </strong>– A custom site will have all the features you would like to use for the marketing of your business.  Your web designer can help you compile a prioritized list which they can implement into the structure of the site itself. And if you are on a strict budget, you can discuss future features with the designer which can be added later.</p>
	<p style="text-align: justify"><strong>Unique design</strong> – When you need something completely original and eye-catching, custom site design is the only way to go.</p>
	<p style="text-align: justify"><strong>SEO optimized</strong> – With the right web designer, your site will be completely SEO optimized and search engine friendly.</p>
	<p style="text-align: justify"><strong>Scalability</strong> – This involves creating a unique site architecture which takes into consideration any future features you would like to upgrade to.  A custom designer will accordingly select the right technologies for your site so that any upgrades you desire are easily incorporated into the design.</p>
...
<div class="servie-key-points">
  <h4>Advantages of Custom Web Design </h4>
  <ul class="key-points mt20">
      <li>Dynamic Web Application Development</li>
      <li>App Upgrade and Maintenance</li>
      <li>Enterprise App Interface and Development</li>
      <li>User Interactive Module Development</li>
      <li>Custom AngularJS Development</li>
      <li>Application Migration Service</li>
				...
				<div class="container">
					...
					<div class="col-lg-8">
						<div class="common-heading ptag">
							...
							<h2>Our Model Is Based On 4 Pillars</h2>
							<p class="mb30">We make sure that our projects are stood on these four pillars to keep it working.</p>
						</div>
					</div>
				</div>
				...
				<div class="itm-media-object mt40">
					<div class="media">
						...
						<div class="media-body">
							<h4>COMMUNICATION</h4>
							<p style="text-align:justify;">
				 Our developers are trained in effective communication and are available to you directly in real-time. Communication gaps that plague traditional outsourcing.</p>
						</div>
					</div>
					...
					<div class="media mt40">
						...
						<div class="media-body">
							<h4> TRUST</h4>
							<p style="text-align:justify;">
				No partnership can function without trust. All shore was built on trust and we know but something to be earned, respected and preserved.</p>
						</div>
					</div>
				</div>
						...
						<div class="row justify-content-center">
							<div class="col-lg-6 col-sm-6 mt30  wow fadeIn" data-wow-delay=".2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeIn;">
								<div class="s-block wide-sblock">
									<div class="s-card-icon"><img src="images/icons/customize.png" alt="service" class="img-fluids"></div>
									<div class="s-block-content">
										<h4>Customized to Your Needs </h4>
										
										<p style="text-align:justify;">
											Whether your company is large and established, or just starting out, tonghor.com can design and develop a new website customised to your business needs. Our team have access to professional Content Strategy, Illustrators, Photographers and Marketing specialists to ensure your new site has the professional attention it deserves.</p>
									</div>
								</div>
							</div>
							<div class="col-lg-6 col-sm-6 mt30 wow fadeIn" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeIn;">
								<div class="s-block wide-sblock">
									...
									<div class="s-block-content">
										...
										<p style="text-align:justify;">
											We also use coding technologies that are compatible with Mobile Phone and Tablet platforms. We provide everything you need to get that new site launched. We can register or transfer your Domain Name, setup your Email and Website Hosting and provide SEO services to make sure your new website is found in search engines.</p>
									</div>
								</div>
							</div>
							<div class="col-lg-6 col-sm-6 mt30 wow fadeIn" data-wow-delay=".8s" style="visibility: visible; animation-delay: 0.8s; animation-name: fadeIn;">
								<div class="s-block wide-sblock">
									...
									<div class="s-block-content">
										...
										<p style="text-align:justify;">
											We offer a wide range of flexible web design options for all of our services, including training that allow you to understanding visually to your new business website. Our Digital Agency compromise all the Marketing and PPC Campaigns also have no fixed contract length, so you can try them out and cancel at any time without penalty.</p>
									</div>
								</div>
							</div>
							<div class="col-lg-6 col-sm-6 mt30 wow fadeIn" data-wow-delay="1.1s" style="visibility: visible; animation-delay: 1.1s; animation-name: fadeIn;">
								<div class="s-block wide-sblock">
									...
									<div class="s-block-content">
										...
										<p style="text-align:justify;">
											If you would like more information about one of our products, or have any other questions, please let us know, it’s important to keep the information on your website up-to-date. If you have modifications to your website you need seen to, please Email your requirements to our support team to ensure your website content is current.</p>
									</div>
								</div>
							</div>
...
connect with our Sales team to help you understand better.</p>
           ...
           <div class="card-1 ">
              ...
              <div id="collapse-e" class="card-body collapse" aria-labelledby="faq5" data-parent="#accordion2">
                <p>
Totally depends on the website being built. The Minimum maintenance is for
30 days &amp; can extend up to 90 days on complex platforms.</p>
              </div>
            </div>
        ...
        <div class="col-md-6 mt60">
          <div id="accordion2" class="accordion">
              ...
              <div class="card-header" id="faq2" style="background: linear-gradient(135deg,#3F74A3,#0000AA 32%,#4D4DFF);">
                ...
                Can I see some sample Websites Designed by you?
                </button>
              </div>
              <div id="collapse-f" class="card-body collapse" aria-labelledby="faq2" data-parent="#accordion2">
                <p>
					Yes, view our website designing portfolio here.</p>
              </div>
            </div>
			  <div class="card-1 ">
              <div class="card-header" id="faq4" style="background: linear-gradient(135deg,#3F74A3,#0000AA 32%,#4D4DFF);">
                ...
                What is the complete Pricing and Process?
                </button>
              </div>
              <div id="collapse-b" class="card-body collapse" aria-labelledby="faq4" data-parent="#accordion2">
                <p>
					Kindly contact our Team to have a proper conversation and view about the
same.</p>
              </div>
            </div>
