...
<div class="container">
    ...
    <blockquote>
      <p> The cloud services companies of all sizes…The cloud is for everyone. The cloud is a democracy.</p>
      <footer>
...
<span class="text-light text-animation bg-b">GROW TRAFFIC &amp; INCREASE REVENUE</span>
	<h2>Server Migration Services</h2>
	
<p style="text-align: justify">
Don’t let old hardware or unsupported software take down your business.</p>
<p style="text-align: justify">Servers can have many functions, and there are many reasons you may be forced to migrate your severs. Whether it be a strategic move to a hosted computing environment, dealing with a data loss incident, moving servers to enhance business intelligence, or to build a simpler computing construct, migration is an extremely detailed process. One that requires the knowledge and expertise a trained IT professional can provide.</p><p style="text-align: justify">
At WEBINGO, our technicians not only understand how important your servers are for your business, they hold the certifications needed to make your company’s server migration go smoothly. We deliver migration options that you may not have considered. Armed with industry best practices, and today’s most dynamic computing solutions, we can get your data, infrastructure, applications, and more migrated successfully. </p>
...
<img src="images/server.png" alt="image" class="img-fluid no-shadow">
</div>
</div>
</div>
</div>
</section>
	  <section class="about-agency bg-gradient15 pad-tb">
<div class="container">
<div class="row">
<div class="col-lg-6 v-center">
<div class="image-block">
<img src="images/server2.png" alt="about" class="img-fluid no-shadow">
</div>
</div>
<div class="col-lg-6">
<div class="common-heading text-l">
<span class="text-light text-animation bg-b">We have capable experts</span>
<h2>Certified Professionals for Seamless Transition.</h2>
<p style="text-align: justify">
With WEBINGO, you get access to a team of professionally trained and certified experts who develop an ideal migration solution to fit your need after assessing deeply your current situation, and understanding your business objectives. Our server migration services are provided with complete aspect of implementation and continued support with on-demand post migration consultancy services. With a wide array of systems and storage, we bring to you the choice of technology scalability, operating system, etc and maintain flexibility while answering the needs of your business. </p>
	  ...
	  <section class="service pad-tb" style="padding-bottom:0px">
...
<div class="servie-key-points">
  ...
  <ul class="key-points mt20"> 
		...
		<li>Migrate your Windows server, Linux server, Mac OS X server.</li>
		<li>Migrate from Windows to Linux hosts and vice-versa.</li>
		<li>Migrate SQL server, MySQL server.</li>
		<li>Migrate web applications such as PHP, Perl, Python, ASP.NET, JAVA, etc.</li>
		<li>email server or email accounts migration.</li>
		<li>ODBC Connections / Configurations.</li> 
  </ul>
</div>
</div>
<div class="col-lg-6 v-center">
<div class="image-block">
<img src="images/server-migration.png" alt="about" class="img-fluid no-shadow">
</div>
</div>
	  ...
	  <section class="about-agency pad-tb bg-gradient15">
<div class="container">
<div class="row">
...
<div class="common-heading text-l">
<span class="text-light text-animation bg-b">GROW TRAFFIC &amp; INCREASE REVENUE</span>
<h2>The Server Migration Services Include:</h2>
<p style="text-align: justify">Seamlessly move into your new server, without having to bother about data center or control
panel with BrainPulse. Our server migrations services are specifically devised to meet
situations of outgrown servers, new data center relocation, instant upgrade of your current
infrastructure. We schedule migrations that suit your business, render minimal downtime and
offer least service interruption in India. With us, you get to evaluate your options as per the
latest requirements and expected growth rate, along with OS and control panel version
updates. All you need to do is sit back and relax since BrainPulse will configure new server,
migrate files and update DNS. </p>
<a href="#" class="btn-main bg-btn lnk mt30">Learn More <i class="fas fa-chevron-right fa-icon"></i><span class="circle"></span></a>
</div>
</div>
	<div class="col-lg-6 v-center">
<div class="image-block">
<img src="images/server3.png" alt="about" class="img-fluid no-shadow">
</div>
</div>
</div>
</div>
...
<div class="s-block" data-tilt="" data-tilt-max="5" data-tilt-speed="1000" style="will-change: transform; transform: perspective(1000px) rotateX(-4.69deg) rotateY(-2.56deg) scale3d(1, 1, 1); transition: all 1000ms cubic-bezier(0.03, 0.98, 0.52, 0.99) 0s;">
<div class="s-card-icon"><img src="images/icons/database-storage.png" alt="service" class="img-fluid"></div>
<h4>Discover</h4>
<p>Discovering which apps and DB workloads are running on existing servers.</p>
...
<div class="s-card-icon"><img src="images/icons/big-data.png" alt="service" class="img-fluid"></div>
<h4>Asses</h4>
<p>Categorize your apps and DB’s By type, criticality, complexity and risk.</p>
<!--<a href="javascript:void(0)">Learn More <i class="fas fa-chevron-right fa-icon"></i></a>-->
</div>
</div>
...
<div class="s-block" data-tilt="" data-tilt-max="5" data-tilt-speed="1000" style="will-change: transform; transform: perspective(1000px) rotateX(0deg) rotateY(0deg) scale3d(1, 1, 1);">
<div class="s-card-icon"><img src="images/icons/challenge.png" alt="service" class="img-fluid"></div>
<h4>Target</h4>
<p> Destinations - AWS, CentOS/ Ubuntu, Windows Servers, or Cross Platform.</p>
<!--<a href="javascript:void(0)">Learn More <i class="fas fa-chevron-right fa-icon"></i></a>-->
</div>
</div>
...
<h4>Migrate</h4>
<p>Setting up new IPv4’s that won’t disrupt your business.</p>
<!--<a href="javascript:void(0)">Learn More <i class="fas fa-chevron-right fa-icon"></i></a>-->
</div>
</div>
</div>
...
<div class="col-lg-6 v-center">
<div class="image-block">
<img src="images/server4.png" alt="about" class="img-fluid no-shadow">
</div>
</div>
<div class="col-lg-6">
<div class="common-heading text-l">

<h2>Why do businesses need efficient and secure Data Migration services?</h2>
<p>

Partial or incorrect data migration process execution can cost businesses a lot of effort and money and also affect the overall functioning of the business. Comparatively an efficient data migration process execution allows businesses to be worry-free and focus on other important operational aspects. With the help of WEBINGO, businesses no longer need to worry about managing their data. Our in-house experts are leading industry professionals experience in Data Migration Services. We will help you save money, effort and time! </p>
          ...
          <div id="accordion" class="accordion">
            <div class="card-1">
              ...
              <div id="collapse-a" class="card-body collapse " aria-labelledby="faq1" data-parent="#accordion">
                <p>
				It depends on how many servers we are migrating and any re-platforming or refactoring that may be required. WSM guarantees engagement on small and mid-sized business migrations within three business days. Optional, same-day expedited engagement is optionally available.</p>
              </div>
            </div>
           <div class="card-1 ">
          ...
          <div id="accordion2" class="accordion">
            <div class="card-1 ">
              ...
              <div id="collapse-4" class="card-body collapse " aria-labelledby="faq4" data-parent="#accordion2">
                <p>
				Yes. The testing phase of the migration will allow you to thoroughly review each and every operation of your migrated websites and services, and we will only make the applications ‘live’ at the new server when you tell us they all work as expected.</p>
              </div>
            </div>
			  <div class="card-1 ">
              <div class="card-header" id="faq4" style="background: navy">
              ...
              <div id="collapse-1" class="card-body collapse " aria-labelledby="faq4" data-parent="#accordion2">
                <p>
				In most cases, we can seamlessly migrate your website and related services without ever alerting your current web host. Your host won’t know you’ve migrated until after the move is complete, your services are live at the new host, and you decommission your former hosting account or infrastructure.</p>
              </div>
            </div>
