...
<span class="text-light text-animation bg-b">GROW TRAFFIC &amp; INCREASE REVENUE</span>
	<h2 style="font-size:30px">Lead Generation</h2>
...
<img src="images/lead.png" alt="image" class="img-fluid no-shadow">
</div>
</div>
</div>
</div>
...
<div class="col-lg-7">
<div class="text-l service-desc- pr25">
  <h3 style="color:#000">Lead Generation Includes</h3>
	<h5 class="mt10 mb20"></h5>
	<p style="text-align: justify">However, a growth plan focuses specifically on expansion and how you&#39;re going to achieve
it. Creating a useful plan takes time, but the effort can pay off substantially by keeping your
growth efforts on track. A growth plan includes</p>
  <ul class="service-point-2 mt20">
  
    <li># PPC advertising services</li>
...
<div class="servie-key-points">
  ...
  <ul class="key-points mt20"> 
      ...
      <li>Increase in Sales and Profit Ratio</li>
      <li>Contributes to a Positive ROI</li>
      <li>Target Desired Customers</li>
      <li>Beneficial to both Buyer and Seller</li>
      <li>Collects Important Information about Prospects</li>
      <li>Costs less than Other Advertisements</li>
...
<div class="servie-key-points">
  ...
  <ul class="key-points mt20"> 
      ...
      <li>Track Campaigns With Complete Transparency</li>
      <li>Bring Your Brand Out From the Shadows</li>
      <li>Take Control in the Driver’s Seat</li>
      <li>You Only Pay When They Click</li>
      <li>Get a Second Chance With Missed Connections</li>
      <li>Increase Website Traffic &amp; Sales</li>
      <li>PPC Advertising is Immune to SEO Changes</li>
...
<div class="col-lg-7">
<div class="text-l service-desc- pr25">
  <h3 style="color:#000">PPC advertising services </h3>
	<h5 class="mt10 mb20"></h5>
	<p style="text-align: justify">
...
<div class="col-lg-7">
<div class="text-l service-desc- pr25">
  <h3 style="color:#000">Search engine marketing and benefits</h3>
	<h5 class="mt10 mb20"></h5>
	<p style="text-align: justify">Search engine marketing is the practice of marketing a business using paid advertisements that appear on search engine results pages (or SERPs). Advertisers bid on keywords that users of services such as Google and Bing might enter when looking for certain products or services, which gives the advertiser the opportunity for their ads to appear alongside results for those search queries.<br>
...
<div class="servie-key-points">
  ...
  <ul class="key-points mt20"> 
      ...
      <li>Implement And Manage Ads Easily And Quickly</li>
      <li>Target The Right Audience Through Optimized Ads</li>
      <li>Increase Traffic Through Ad Visibility</li>
      <li>Pay Only Per Action</li>
     <li>Appear On Competitors’ Related Keywords </li>
	  <li>Test And Measure Your Performance</li>
  </ul>
</div>
</div>
</div>
...
<div class="container">
	...
	<div class="col-lg-8">
		<div class="common-heading ptag">
			...
			<h2 style="font-size: 36px;">How we do it?</h2>
			<p class="mb30">There are countless of growth strategies for businesses, but only four major types. With
these growth strategies, you can determine how to build on your brand.</p>
		</div>
	</div>
</div>
<div class="row">
...
<div class="itm-media-object mt40">
	<div class="media">
		...
		<div class="media-body">
			...
			<p>A market strategy refers to how you plan to penetrate your target
clientele. </p>
		</div>
	</div>
	<div class="media mt40">
		...
		<div class="media-body">
			<h4> Development</h4>
			<p>This strategy applies to looking into ways to break your products and
services into a new market.</p>
		</div>
	</div>
...
<div class="itm-media-object ">
	<div class="media mt40">
		...
		<div class="media-body">
			...
			<p>This stage is also referred to as product development. For this
strategy,  </p>
		</div>
	</div>
	<div class="media mt40">
		...
		<div class="media-body">
			...
			<p> Diversification refers to expanding both your products and target
markets. </p>
		</div>
	</div>
