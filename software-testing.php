...
<div class="container">
    ...
    <blockquote>
      <p>Quality is a challenge. We will help you find the best solution.</p>
      <footer>
...
<span class=" text-light text-animation bg-b">GROW TRAFFIC &amp; INCREASE REVENUE</span>
	<h2>Software testing to empower application to perform better.</h2>
	
<p style="text-align: justify">WEBINGO, one of the leading testing and development companies, delivers software testing services and quality assurance services for desktop and mobile applications, to drive quality to your product. Our testing experts work directly with your team to create an end-to-end process that works consistently and rapidly while providing you dedicated support and seamless feedback. Our services are directed to help you achieve quality at speed and ensure that you have a secure online existence. We don’t just promise high quality testing services, we deliver. </p>
...
<img src="images/soft_test.png" alt="image" class="img-fluid no-shadow">
</div>
</div>
</div>
</div>
      ...
      <div class="row justify-content-center">
        <div class="col-lg-8">
          <div class="common-heading">
            ...
            <h2 class="mb30">Our focus areas in Software Testing.</h2>
          </div>
        </div>
      </div>
      <div class="row upset link-hover">
        <div class="col-lg-4 col-sm-6 mt30">
          <div class="s-block">
            ...
            <p> Proven package of services for the delivery of flawless system functionality.</p>
              <!--<a href="javascript:void(0)">Learn More <i class="fas fa-chevron-right fa-icon"></i></a>-->
          </div>
        </div>
        <div class="col-lg-4 col-sm-6 mt30">
          <div class="s-block">
            <div class="s-card-icon"><img src="images/icons/testing-2.png" alt="service" class="img-fluid"></div>
            <h4>PERFORMANCE TESTING</h4>
            <p> Seamless integration of performance testing services at any stage of SDLC.</p>
             <!--<a href="javascript:void(0)">Learn More <i class="fas fa-chevron-right fa-icon"></i></a>-->
          </div>
        </div>
        <div class="col-lg-4 col-sm-6 mt30">
          <div class="s-block">
            ...
            <p>We protect your business from cyber attacks.</p>
              <!--<a href="javascript:void(0)">Learn More <i class="fas fa-chevron-right fa-icon"></i></a>-->
          </div>
        </div>
        <div class="col-lg-4 col-sm-6 mt30">
          <div class="s-block">
            <div class="s-card-icon"><img src="images/icons/laptop.png" alt="service" class="img-fluid"></div>
            <h4>COMPATIBILITY TESTING</h4>
            <p>Complete application compatibility with a1qa software testing services.</p>
              <!--<a href="javascript:void(0)">Learn More <i class="fas fa-chevron-right fa-icon"></i></a>-->
          </div>
        </div>
        <div class="col-lg-4 col-sm-6 mt30">
          <div class="s-block">
            ...
            <p> We help you see the world through your customers’ eyes.</p>
           <!--<a href="javascript:void(0)">Learn More <i class="fas fa-chevron-right fa-icon"></i></a>-->
          </div>
        </div>
        <div class="col-lg-4 col-sm-6 mt30">
          <div class="s-block">
            ...
            <p>Speak your clients' language for better communication.</p>
            <!--<a href="javascript:void(0)">Learn More <i class="fas fa-chevron-right fa-icon"></i></a>-->
          </div>
        </div>
      </div>
...
<div class="servie-key-points">
  ...
  <ul class="key-points mt20">  
	  <h5>Full-cycle testing services </h5>
		<li>QA consulting</li> 
		<li>Software lifecycle</li> 
		<li>QA Managed</li> 
		<li>QA Test automation </li>
		<li>Pre-certification testing </li>
...
<div class="servie-key-points">
  ...
  <ul class="key-points mt20">  
	  ...
	  <h5>Systems & platforms </h5>
		<li>Web apps testing </li>
		<li>Mobile apps testing </li>
		<li>Blockchain app testing </li>
		<li>CRM testing </li>
		<li>AR & VR testing </li>
		<li>Cloud testing</li> 
		<li>IoT testing</li>
...
<div class="servie-key-points">
  ...
  <ul class="key-points mt20">  
      ...
      <h5>Quality engineering </h5>
		...
		<li>Testing in Agile</li> 
		<li>Microservices testing</li>
...
<section class="service-section bg-gradient15 pad-tb">
<div class="container">
<div class="row justify-content-center">
<div class="col-lg-8">
<div class="common-heading">
<span class="text-radius  text-animation bg-b">Service We Provided</span>
<h2 class="mb30">Testing Methods we follow</h2>
</div>
</div>
</div>
...
<div class="s-card-icon"><img src="images/icons/versility.png" alt="service" class="img-fluid"></div>

<p>Defining Key Points</p>
...
<div class="s-card-icon"><img src="images/icons/color.png" alt="service" class="img-fluid"></div>

<p >Test case analysis &amp; designing</p>
...
<p >Result analysis &amp; accountability</p>
...
<div class="container">
<div class="row mobilehide1">
<div class="col-lg-6">
<div class="text-l service-desc- pr25">
	<span class="text-radius text-light text-animation bg-b">Mobile app development</span>
	<h2>Why Invest in Software Testing?</h2>
 
  <p>Software testing refers to the process of executing programs and applications in order to find software
 bugs and other defects.   By getting your software tested, you
can find out if your product -.</p>
  <ul class="service-point mt20 key-points ">
     <li>Satisfies the requirements of your stakeholders</li>
     <li>Meets the required design and development requirements</li>
      <li>Performs as expected</li>
      <li>Can be executed with the same characteristics</li>
  </ul>
  <a href="#" class="btn-main bg-btn2 lnk mt30">Request A Quote  <i class="fas fa-chevron-right fa-icon"></i><span class="circle"></span></a>
</div>
</div>
<div class="col-lg-6 pull-right">
 ...
 <img src="images/soft_test2.png" alt="image" class="img-fluid">
          ...
          <div id="accordion" class="accordion">
           ...
           <div class="card-1 ">
              ...
              <div id="collapse-d" class="card-body collapse " aria-labelledby="faq4" data-parent="#accordion2">
                <p>
				Software Quality Assurance is defined by the activities that monitor, measure, evaluate and validate the processes used to create software.</p>
              </div>
            </div>
          ...
          <div id="accordion2" class="accordion">
            <div class="card-1 ">
              ...
              <div id="collapse-4" class="card-body collapse " aria-labelledby="faq4" data-parent="#accordion2">
                <p>
					Undoubtedly. Testing for quality is paramount to the success of any software product. Without proper QA, the chances for success diminish significantly.</p>
              </div>
            </div>
			  <div class="card-1 ">
              <div class="card-header" id="faq4" style="background: navy">
              ...
              <div id="collapse-1" class="card-body collapse " aria-labelledby="faq4" data-parent="#accordion2">
                <p>
				A test plan is a document that details the approach to testing a software product. Test plans provide needed guidelines for any tester or test team and ensure that every facet of the software functionality is tested.</p>
              </div>
            </div>
