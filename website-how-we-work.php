...
<html lang="en" class="no-js">
 ...
 <!-- <section class="breadcrumb-area pink banner-2" style="padding-bottom: 0px">
    ...
    margin-top: 179px;">
	    ...
	    <!--Breadcrumb Area-->
  <section class="breadcrumb-area " style="padding: 32px 0px 32px 0px;background:#4d4dff">
    <div class="text-block">
      <div class="container">
        <div class="row">
            ...
            <div class="col-sm-4 col-xs-6 tabbanrt" style="margin-top: 4%">
				<div class="banner_pic">
					<picture>
						...
						<img src="images/image2/how_we_work.png" alt="" />
					</picture>
				</div>
			</div>
			 <div class="col-sm-4 col-xs-6 tabbanrt" style="margin-top: 4%">
      ...
      <div class="row justify-content-center">
        <div class="col-lg-8">
          <div class="common-heading ptag">
              <span>Service</span>
            <h2 class="mb30">We follow three major steps</h2>
      ...
      <div class="row justify-content-center">
        <div class="col-lg-4 col-sm-6 mt30  wow fadeIn" data-wow-delay=".2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeIn;">
          <div class="s-block wide-sblock">
            ...
            <div class="s-block-content">
               <h4>Understanding</h4>
            <p> We listen to you and understand about your problems and  needs.</p>
            </div>
          </div>
        </div>
        <div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeIn;">
          <div class="s-block wide-sblock">
            ...
            <div class="s-block-content">
              <h4>Creating</h4>
            <p> We monitor the need closely and create the best solution.</p>
            </div>
          </div>
        </div>
        <div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay=".8s" style="visibility: visible; animation-delay: 0.8s; animation-name: fadeIn;">
          <div class="s-block wide-sblock">
            ...
            <div class="s-block-content">
              <h4>Delivering</h4>
            <p> We finally deliver you the <br>best.
				</p>
            </div>
          </div>
        </div>
      ...
      <div class="row upset link-hover">
        <div class="col-lg-4 col-sm-6 mt30">
          <div class="s-block">
            ...
            <p> After receiving your interest in our organisation, we plan our first
Interaction. </p>
        ...
        <div class="col-lg-4 col-sm-6 mt30">
          <div class="s-block">
            ...
            <p>The team discusses about your business and your needs to come up with
a solution.</p>
            <a href="javascript:void(0)">Learn More <i class="fas fa-chevron-right fa-icon"></i></a>
          </div>
        </div>
        <div class="col-lg-4 col-sm-6 mt30">
          <div class="s-block">
            ...
            <p>We share the solution<br> and suggestions <br>with you.</p>
            <a href="javascript:void(0)">Learn More <i class="fas fa-chevron-right fa-icon"></i></a>
          </div>
        </div>
        <div class="col-lg-4 col-sm-6 mt30">
          <div class="s-block">
            ...
            <p>After the approval of solution, we design the initial pages and show you the
design. </p>
            <a href="javascript:void(0)">Learn More <i class="fas fa-chevron-right fa-icon"></i></a>
          </div>
        </div>
        <div class="col-lg-4 col-sm-6 mt30">
          <div class="s-block">
            ...
            <h4>Development</h4>
            <p>The design layout is then converted into a working website using the best
techniques.</p>
            <a href="javascript:void(0)">Learn More <i class="fas fa-chevron-right fa-icon"></i></a>
          </div>
        </div>
...
experience.</p>
          ...
          <div class="s-block">
            <div class="s-card-icon"><img src="images/icons/graphic.svg" alt="service" class="img-fluid"></div>
            <h4>Final Review</h4>
            <p>After creating the final version, the output is shared with you for review. Final
changes will be provided before the website is made live on the Internet.</p>
            <a href="javascript:void(0)">Learn More <i class="fas fa-chevron-right fa-icon"></i></a>
          </div>
        </div>
        <div class="col-lg-4 col-sm-6 mt30">
          <div class="s-block">
            <div class="s-card-icon"><img src="images/icons/video.svg" alt="service" class="img-fluid"></div>
            <h4>Launch</h4>
            <p> The website is made live on the Internet. If other services such as, digital marketing,
SEO, and so on are opted. We start working on it.</p>
            <a href="javascript:void(0)">Learn More <i class="fas fa-chevron-right fa-icon"></i></a>
          </div>
        </div>
        <div class="col-lg-4 col-sm-6 mt30">
          <div class="s-block">
            <div class="s-card-icon"><img src="images/icons/design-icon.svg" alt="service" class="img-fluid"></div>
            <h4>Support</h4>
            <p> We provide a limited period support and extended support<br> depending on the
package <br>opted for.</p>
            <a href="javascript:void(0)">Learn More <i class="fas fa-chevron-right fa-icon"></i></a>
          </div>
        </div>
      </div>
