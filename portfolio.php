 ...
 <section class="service pad-tb about-agency light-dark ">
	 ...
	 <div class="container">
		 <div class="row">
			...
			<div class="case-study study1 bd-hor-base">
				<figure>
					<img class="case-study__img" src="images/image2/demo.jpg" alt="" />
				</figure>
			  <div class="case-study__overlay">
				<h2 class="case-study__title">Web Design</h2>
			...
			<div class="case-study study3">
			  ...
			  <div class="case-study__overlay">
				<h2 class="case-study__title">Business Card Design</h2>
				<div class="col-md-12 text-center">
				<a class="btn btn-primary case-study__link" href="#">View More</a>
				 </div>
			  </div>
			...
			<div class="case-study study5">
			  ...
			  <div class="case-study__overlay">
				<h2 class="case-study__title">Packaging Design</h2>
				  <div class="col-md-12 text-center">
				<a class="btn btn-primary case-study__link" href="#">View More</a>
				 </div>
			  </div>
			...
			<div class="case-study study6">
			  ...
			  <div class="case-study__overlay">
				<h2 class="case-study__title">Wordpress Design</h2>
				<div class="col-md-12 text-center">
				<a class="btn btn-primary case-study__link" href="#">View More</a>
				 </div>
			  </div>
