...
<div class="text-l service-desc- pr25">
	...
	<br>
<p style="text-align: justify">Our Team specializes in developing and launching fully functional and dynamic custom websites and web apps. We develop the best website and web application imaginable starting with designing a great user experience interface. We make it possible for you to present your business in an effective and modern way. We know how important it is to gain an advantage over your competitors to increase revenue. Therefore, we employ only the best team of developers to build and integrate feature-rich, robust and secure web development solutions for our clients. We offer intuitive and user-friendly websites and web apps.</p>
...
<div class="col-lg-7">
<div class="text-l service-desc- pr25">
  <h3 class="mb20" style="color:#000">Let us give you some insight about Custom Web Development </h3>  
  <p style="text-align:justify;">
	We focus on quality of code and always follow W3C coding standards. Moreover, we use the latest trends and strategies to keep our projects up-to-date with the international standards that boasts of beautiful and aesthetically appealing designs. Our custom web development services include designing and development of a variety of websites such as business websites, portal site and so much more. Catering to the specific demands of web users and our clients, we have also built an array of e-commerce websites with excellent shopping cart developments and innovative micro sites for products and brand promotion.</p>
...
<div class="servie-key-points">
  ...
  <ul class="key-points mt20">
	  ...
	  <li>Social Website Development.</li>
...
<div class="text-l service-desc- pr25">
	...
	<br>
	<p style="color:#000;">➣ Website unique design.</p>
	<p style="color:#000;">➣ Personalized web design that will fit the business.</p>
	<p style="color:#000;">➣ The website will be more adaptable to your company’s needs.</p>
	<p style="color:#000;">➣ Your website could have a good “scalability.”</p>
	<p style="color:#000;">➣ Search engine friendly.</p>
	  ...
	  <section class="service-block pad-tb bg-gradient8">
						...
						<div class="row justify-content-center">
							<div class="col-lg-6 col-sm-6 mt30  wow fadeIn" data-wow-delay=".2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeIn;">
								<div class="s-block wide-sblock">
									...
									<div class="s-block-content">
										...
										<p style="text-align:justify;">The page loading time is a key factor for the overall performance of a website. To keep the speed to minimum we reduce HTTP request, minify, cookie-free domain, and use SSD hosting to maintain the speed for a faster experience.</p>
									</div>
								</div>
							</div>
							<div class="col-lg-6 col-sm-6 mt30 wow fadeIn" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeIn;">
								<div class="s-block wide-sblock">
									...
									<div class="s-block-content">
										<h4>Scalability</h4>
										<p style="text-align:justify;">Customized website development gives you an advantage of selecting technologies on which you want your website to be developed. Later on, this can help you in scaling your business and update your website for future business necessities.</p>
									</div>
								</div>
							</div>
							<div class="col-lg-6 col-sm-6 mt30 wow fadeIn" data-wow-delay=".8s" style="visibility: visible; animation-delay: 0.8s; animation-name: fadeIn;">
								<div class="s-block wide-sblock">
									...
									<div class="s-block-content">
										<h4>Security</h4>
										<p style="text-align:justify;    font-size: 16px;">An unprotected website is a security risk to customers, and can spread a malware. A website created by our website developers is highly secure. Customers have a peace of mind that the site can be trusted and the information is safe.</p>
									</div>
								</div>
							</div>
							<div class="col-lg-6 col-sm-6 mt30 wow fadeIn" data-wow-delay="1.1s" style="visibility: visible; animation-delay: 1.1s; animation-name: fadeIn;">
								<div class="s-block wide-sblock">
									...
									<div class="s-block-content">
										...
										<p style="text-align:justify;">Option for custom web development services gives you the opportunity to pay only for those functionalities that you require. So, there is no bank breaking budget, and you can easily plan your money timeline prior to the development.</p>
									</div>
								</div>
							</div>
							<div class="col-lg-6 col-sm-6 mt30 wow fadeIn" data-wow-delay="1.4s" style="visibility: visible; animation-delay: 1.4s; animation-name: fadeIn;">
								<div class="s-block wide-sblock">
									...
									<div class="s-block-content">
										...
										<p style="text-align:justify;">We develop our projects based on agile approach that takes away time-sucks, performing frequent sanity checks, and making sure that you’re not spending excessive time on things that don’t add value to the project.</p>
									</div>
								</div>
							</div>
							<div class="col-lg-6 col-sm-6 mt30 wow fadeIn" data-wow-delay="1.7s" style="visibility: visible; animation-delay: 1.7s; animation-name: fadeIn;">
								<div class="s-block wide-sblock">
									<div class="s-card-icon"><img src="images/icons/implementer.png" alt="service" class="img-fluids"></div>
									<div class="s-block-content">
										<h4>Content Management</h4>
										<p style="text-align:justify;">Web Apps that are customized comprises of easy site management tools where the non-technical members of the organization like managers, and other team members can make changes without any technical assistance.</p>
									</div>
								</div>
							</div>
						</div>
				...
				If a person remembers about your logo, they automatically trust you are more likely to involve with your product/services.</p>
					...
					<div class="media mt40">
						...
						<div class="media-body">
							<h4>Custom Content Management System</h4>
							<p style="text-align:justify;">
				If a person remembers about your logo, they automatically trust you are more likely to involve with your product/services.</p>
						</div>
					</div>
...
phase we show the progress to you.</p>
           ...
           <div class="card-1 ">
              ...
              Do you provide domain and hosting services as <br>well?
                </button>
              </div>
          ...
          <div id="accordion2" class="accordion">
            ...
            <div class="card-1 ">
              <div class="card-header" id="faq2" style="background: linear-gradient(135deg,#3F74A3,#0000AA 32%,#4D4DFF);">
                ...
                After launch of the website, do you provide marketing services too?
                </button>
              </div>
              <div id="collapse-f" class="card-body collapse" aria-labelledby="faq2" data-parent="#accordion2">
                <p>
					Yes. You can select suitable plan from our Marketing service package and we will
					provide the service along with any other IT service you need.</p>
              </div>
            </div>
          </div>
