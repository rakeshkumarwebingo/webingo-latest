...
<html lang="en" class="no-js">
 ...
 <!-- <section class="breadcrumb-area pink banner-2" style="padding-bottom: 0px">
    ...
    margin-top: 179px;">
	    ...
	    <!--Breadcrumb Area-->
  <section class="breadcrumb-area " style="padding: 32px 0px 32px 0px;background:#262673">
    <div class="text-block">
      <div class="container">
        <div class="row">
            ...
            <div class="col-sm-4 col-xs-6 tabbanrt" style="margin-top: 4%">
				<div class="banner_pic">
					<picture>
						...
						<img src="images/image2/trust.png" alt="" />
					</picture>
				</div>
			</div>
			 <div class="col-sm-4 col-xs-6 tabbanrt" style="margin-top: 4%">
...
<div class="text-l service-desc- pr25">
	...
	<h2>We don't want to please everyone. We just want to please you.</h2>
	<br>
<p style="text-align: justify">We aim to create the best digital products while keeping things simple. As a result, we're
recognised as one of the top web design and development companies in the area.
We take our work very seriously, but we don't take ourselves too seriously. We love doing
what we do, and you'll enjoy working with us. Our teams are small and agile, when you
work with us, you'll feel like part of the family.</p>
...
<img src="images/trust.png" alt="image" class="img-fluid no-shadow">
</div>
</div>
</div>
</div>
...
<section class="service-block about-agency bg-gradient15 pad-tb">
    <div class="container">
      ...
      <div class="row justify-content-center">
        <div class="col-lg-8">
          <div class="common-heading">
            <span>Service</span>
            <h2 class="mb30">We're Passionate & Friendly People</h2>
          </div>
        </div>
      </div>
      <div class="row upset link-hover">
        <div class="col-lg-3 col-sm-6 mt30">
          <div class="s-block">
            ...
            <h4>We LISTEN</h4>
            <p>We can only deliver results if we know what your success looks like. We
listen, find out what you want to achieve and plan how we get you there. Things
work better when we do it together.</p>
        ...
        <div class="col-lg-3 col-sm-6 mt30">
          <div class="s-block">
            ...
            <h4>We Like to talk</h4>
            <p> We'll keep you updated with the progress of the site. We're a small
team, so you'll soon get to know everyone working on your project.
We'll earn your trust and make the process stress-free.</p>
            <a href="javascript:void(0)">Learn More <i class="fas fa-chevron-right fa-icon"></i></a>
          </div>
        </div>
        <div class="col-lg-3 col-sm-6 mt30">
						...
						<div class="row justify-content-center">
							<div class="col-lg-8">
								<div class="common-heading ptag">
									...
									<h2>What makes WEBINGO an ideal partner as a company?</h2>
...
<div class="container">
	...
	<div class="col-lg-8">
		<div class="common-heading ptag">
			<span class="text-radius text-light text-animation bg-b">We Deliver Our Best</span>
			<h2>We are known for excellent customer support</h2>
...
<div class="col-lg-8">
	<div class="common-heading">
		<h2 style="margin-bottom: 10px">Our Renould Clients</h2>
	</div>
</div>
</div>
