...
<div class="text-l service-desc- pr25">
	...
	<br>
<p style="text-align: justify">Mobile application development is the set of processes and procedures involved in writing
software for small, wireless computing devices. Like Web application development, mobile
application development has its roots in more traditional software development. One
critical difference, however, is that Mobile apps are often written specifically to take
advantage of the unique features a particular mobile device offers. </p>
...
<div class="col-lg-7">
<div class="text-l service-desc- pr25">
  <h3 class="mb20" style="color:#000">Benefits of E-Commerce Development </h3>  
...
<div class="servie-key-points">
  <h4>Advantages of E-Commerce Development </h4>
  ...
  <ul class="key-points mt20">
      ...
      <li>Transforming the retail experience.</li>
	  ...
	  <section class="service-block pad-tb bg-gradient8">
						...
						<div class="row justify-content-center">
							<div class="col-lg-4 col-sm-6 mt30  wow fadeIn" data-wow-delay=".2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeIn;">
								<div class="s-block wide-sblock">
									...
									<div class="s-block-content">
										<h4>Excellent Usability</h4>
										
										<p>Want to delight your audience with user experience exceeding their
											expectations? </p>
									</div>
								</div>
							</div>
							<div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeIn;">
								<div class="s-block wide-sblock">
									...
									<div class="s-block-content">
										<h4>Gamut of Features</h4>
										<p>Want to dazzle your users with new features? Our mobile app development
											squad’s </p>
									</div>
								</div>
							</div>
							<div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay=".8s" style="visibility: visible; animation-delay: 0.8s; animation-name: fadeIn;">
								<div class="s-block wide-sblock">
									...
									<div class="s-block-content">
										...
										<p >
										Looking for iPhone app development services, Android or any other app
										development?</p>
									</div>
								</div>
							</div>
							<div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay="1.1s" style="visibility: visible; animation-delay: 1.1s; animation-name: fadeIn;">
								<div class="s-block wide-sblock">
									...
									<div class="s-block-content">
										<h4>Rock-Solid Security Measures</h4>
										<p>
										We help you gain the trust of your users and increase adoption of your app with
										</p>
									</div>
								</div>
							</div>
							<div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay="1.4s" style="visibility: visible; animation-delay: 1.4s; animation-name: fadeIn;">
								<div class="s-block wide-sblock">
									...
									<div class="s-block-content">
										<h4>See &amp; Track Progress Easily</h4>
										<p >
										With our agile Mobile App Development services process, we ensure that you are
										</p>
									</div>
								</div>
							</div>
							<div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay="1.7s" style="visibility: visible; animation-delay: 1.7s; animation-name: fadeIn;">
								<div class="s-block wide-sblock">
									...
									<div class="s-block-content">
										<h4>Marketing made <br>faster</h4>
										<p>
										We help you stay ahead of competitors and invest enough time to plan your app
										</p>
									</div>
								</div>
							</div>
				...
				If a person remembers about your logo, they automatically trust you are more likely to involve with your product/services.</p>
					...
					<div class="media mt40">
						...
						<div class="media-body">
							<h4>React Native Development Services</h4>
							<p style="text-align:justify;">
				If a person remembers about your logo, they automatically trust you are more likely to involve with your product/services.</p>
						</div>
					</div>
        ...
        <div class="col-md-6 mt60">
          <div id="accordion" class="accordion">
           ...
           <div class="card-1 ">
              ...
              Can I get Custom Design?
                </button>
              </div>
              <div id="collapse-e" class="card-body collapse" aria-labelledby="faq5" data-parent="#accordion2">
                <p>
					Yes. You can go for Customized Designs and our Team can make it.</p>
              </div>
            </div>
        ...
        <div class="col-md-6 mt60">
          <div id="accordion2" class="accordion">
              ...
              <div id="collapse-b" class="card-body collapse" aria-labelledby="faq4" data-parent="#accordion2">
                <p>
					The timeframe depends on the size of the project and the features required.</p>
              </div>
            </div>
            <div class="card-1 ">
