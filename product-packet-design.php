...
<img src="images/image2/packing.png" alt="image" class="img-fluid no-shadow">
</div>
</div>
...
<div class="row">
    ...
    <blockquote>
       <p>Jo Dikhta hain Wo Bikta Hain.</p>
      <footer>
...
<span class="text-radius  text-animation bg-b">Service We Provide</span>
            <h2>About Product Packaging & Label Designs</h2>
	<br>
            <p>Product design is the process used to combine customer needs with business motive to help brands make consistently successful products. Product designers work to optimize the customer experience in the solutions they make for their customers—and help their brands by making products sustainable for longer-term business needs.</p>
...
<img src="images/packaging.png" alt="image" class="img-fluid no-shadow">
</div>
</div>
  ...
  <div class="col-lg-6 col-md-12 mt30 wow fadeInUp" data-wow-delay=".8s" style="visibility: visible; animation-delay: 0.8s; animation-name: fadeInUp;">
    <div class="s-block wide-sblock">
      ...
      <div class="s-block-content-large">
        ...
        <p style="margin-bottom:41px">A creative can design is what brings in the youth to try it.</p>
      </div></div>
    </div>
...
<span class="text-radius  text-animation bg-b">We Are Creative Agency</span>
<h2>Product Package designs that will leave you astound!</h2>
	<p style="text-align:justify"><span style="font-weight:900">Eye &nbsp;catching &nbsp;colors:</span> The more eye catchy color, the better. It help’s the product to be noticed from far, even if it is not placed at eye level.
		<span style="font-weight:900">Readable &nbsp;Fonts: </span>A product has a maximum of three seconds of time to attract the eye of any consumer walking down the market aisle.
		<span style="font-weight:900">Logo :</span> Good Logo Incorporation creates better chances for the product to be noticed and picked up from the shelf.
   </p>
...
<div class="user- mt30">
  <div class="media">
	...
	<div class="-cta-btn mt70">
        <div class="free-cta-title v-center wow zoomInDown" data-wow-delay="1.4s" style="visibility: hidden; animation-delay: 1.4s; animation-name: none;">
          <p>Tell us <span>About your product</span></p>
...
<div class="row justify-content-center">
		...
		<div class="stamp-sheet col-md-12">
		  <div class="col-md-3 stamp mobilehide hide">
			<img scr="images/logo-portfolio/1.png">
		  </div>
		  ...
		  <div class="col-md-3  stamp torn mobilelogo">
...
<div class="s-card-icon"><img src="images/icons/clean.png" alt="service" class="img-fluid"></div>
<h4>Simplicity</h4>
...
<h4>Color</h4>
<p style="margin-bottom:28px;">Vibrant colors to be eye catching and attracting.</p>
						...
						<div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeIn;">
							...
							<div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay="1.7s" style="visibility: visible; animation-delay: 1.7s; animation-name: fadeIn;">
								<div class="s-block wide-sblock">
									...
									<div class="s-block-content">
										<h4 >Top Service Quality Guranteed</h4>
      ...
      <div class="row">
        <div class="col-md-6 mt60">
          <div id="accordion" class="accordion">
            ...
            Does a good product packaging increases sale?
                </button>
              </div>
              <div id="collapse-a" class="card-body collapse " aria-labelledby="faq1" data-parent="#accordion">
                <p>
A good product package can increase the chances of perception of your product.</p>
              </div>
            </div>
           <div class="card-1 ">
...
Yes, it is available.</p>
        ...
        <div class="col-md-6 mt60">
          <div id="accordion2" class="accordion">
              ...
              Can WEBINGO help in package design security?
                </button>
              </div>
              <div id="collapse-2" class="card-body collapse " aria-labelledby="faq4" data-parent="#accordion2">
                <p>
Yes, WEBINGO also provides business legal services.</p>
              </div>
            </div>
            <div class="card-1 ">
              <div class="card-header" id="faq4" style="background: linear-gradient(135deg,#3F74A3,#0000AA 32%,#4D4DFF);">
