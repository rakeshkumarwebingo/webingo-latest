...
<!--End Header -->
<!--Breadcrumb Area-->
<section class="bannerss">
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d117933.32000423789!2d88.30647451396742!3d22.526074900000005!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a02777874141a51%3A0x16ddae902fa172d1!2sWEBINGO%20INFOTECH%20SOLUTIONS!5e0!3m2!1sen!2sin!4v1601971979753!5m2!1sen!2sin" allowfullscreen=""></iframe>
<div class="text-block" style="">
  <div class="container">
    <div class="row">
      <!--div class="col-lg-3 v-center" style="padding: 20px;
    background: rgba(0,0,0,.5);">
        <div class="bread-inner">
          <div class="bread-title wow fadeInUp" data-wow-delay=".5s" style="color: white;">
  ...
  <div class="row justify-content-center">
      ...
      <div class="form-block">
        <form id="contact-form" method="post" action="php/contact.php" data-toggle="validator">
          ...
          <div class="fieldsets row">
            <div class="col-md-6 form-group"><input id="name1" type="text" name="name"  placeholder="Enter your name *" required="" data-error="Name is required.">
            <div class="help-block with-errors"></div></div>
            <div class="col-md-6 form-group"><input id="from_email1" type="email" name="email"  placeholder="Enter your email *" required="" data-error="Valid email is required.">
            <div class="help-block with-errors"></div></div>
          </div>
          <div class="fieldsets row">
			  <div class="col-md-2 form-group" style="padding-right:0px">
			      <select id="from_code1" placeholder="code *" required="">
	...
	<optgroup label="Other countries">
		...
		<option data-countrycode="ZW" value="263">Zimbabwe (+263)</option>
            ...
            <div class="help-block with-errors"></div></div>
            <div class="col-md-4 form-group"><input id="from_phone1" type="text" name="phone"  placeholder=" Phone No *" required="required" data-error="Phone No is required.">
            <div class="help-block with-errors"></div></div>
           	 <div class="col-md-6 form-group"><input id="c_name1" type="text" name="company name"  placeholder="Enter your company name *" required="required" data-error="company name is required.">
            <div class="help-block with-errors"></div></div>
          </div>
          <div class="fieldsets form-group"> <textarea id="message1" name="message"  placeholder="Message for me *" rows="4" required="required" data-error="Please, leave us a message."></textarea>
          ...
          <div class="fieldsets mt20">
            <button type="button" class="lnk btn-main bg-btn submit_btn1">Submit <span class="circle"></span></button>
          </div>
    ...
    <div class="col-lg-5 v-center">
      <div class="contact-details">
        <div class="contact-card wow fadeIn" data-wow-delay=".2s" style=" color:white;   background: linear-gradient(135deg,#3F74A3,#0000AA 32%,#4D4DFF);">
          <div class="info-card v-center">
            ...
            <div class="info-body">
              ...
              <a href="tel:+917001300600" style="line-height: 2rem;"><i class="fas fa-phone-alt"></i> (+91) 7001-300-600</a><br>
              <a href="tel:+918389807466" style="line-height: 2rem;"><i class="fas fa-phone-alt"></i> (+91) 83898 07466</a><br>
              <a href="tel:+919732611075" style="line-height: 2rem;"><i class="fas fa-phone-alt"></i> (+91) 97326 11075</a>
            </div>
          </div>
        </div>
        <div class="email-card mt30 wow fadeIn" data-wow-delay=".5s" style=" color:white;   background: linear-gradient(135deg,#3F74A3,#0000AA 32%,#4D4DFF);">
          <div class="info-card v-center">
...
$(document).ready(function(){
    function clr() 
         { 
             ...
             document.getElementById("from_email1").value = "" 
             document.getElementById("from_phone1").value = "" 
             document.getElementById("from_code1").value = "" 
	...
	$(document).on('click', '.submit_btn1', function(){
		...
		var txtname = $('#name1').val();
		var txtemail = $('#from_email1').val();
		var txtphone =$('#from_phone1').val();
		var code = $('#from_code1').val();
		var c_name = $('#c_name1').val();
		var txtmessage = $('#message1').val();
        ...
        if (!document.getElementById("from_phone1").checkValidity()) {
			    alert("phone number not valid");
  document.getElementById("phone_error_header1").style.display = "block";
        }
        else{
    document.getElementById("phone_error_header1").style.display = "none";
    if(!document.getElementById("name1").checkValidity())
        { 
  document.getElementById("first_name_error_header1").style.display = "block";
        }
        else{
    document.getElementById("first_name_error_header1").style.display = "none";
    if (!document.getElementById("from_code1").checkValidity())
        {	
  document.getElementById("last_name_error_header1").style.display = "block";
        }
        else{
    document.getElementById("last_name_error_header1").style.display = "none";
    if(!document.getElementById("from_email1").checkValidity())
        {
  document.getElementById("email_error_header1").style.display = "block";
        }
        else{
    document.getElementById("email_error_header1").style.display = "none";
