...
<!--End Breadcrumb Area-->
  ...
  <!--End Breadcrumb-->  
	  ...
	  <section class="vfx_job_listing_area bg_color vfx_section_pad service pad-tb">
    <div class="container">
      <div class="sec_title mb_50">
        <h2 class="f_p f_size_24 l_height28 f_700 t_color3 mb_20">Available Job for You</h2>
        <p class="f_400 f_size_15">Lorem Ipsum is simply dummy text of the printing and type setting industry. Lorem Ipsum has been the industry's standard dummy text ever since, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p>
      </div>
      
<!-- SVG data-->
		
		
		<section class="service-block pad-b ">
					<div class="container">
						<div class="row justify-content-center">
							<div class="col-lg-8">
								<div class="common-heading ptag">
									<br>
									<h2>View Job Portal</h2>
							...
							<div class="col-lg-4 col-sm-6 mt30  wow fadeIn" data-wow-delay=".2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeIn;">
								...
								<div class="card-banner"><img src="https://content.jobsdbcdn.com/Content/CmsContent/Logo/HK/JobsDBFiles/CompanyLogo/banner-m/34999m.png"/></div>
								<div class="card-logo"><img src="images/white-logo.png"/></div>
								<div class="card__content">
								  <div class="job-title">PHP Developer</div>
								  <div class="job-meta">
									<div class="company">Webingo</div>
									<div class="location">Kolkata</div>
								  </div>
									<div class="job-title">
										<br>
										<a class="btn-custome btn waves-effect waves-light" href="contact.html">Apply Now</a>
									</div>
								</div>
							  </div>
							</div>
							<div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeIn;">
								...
								<div class="card-logo"><img src="images/white-logo.png"/></div>
								<div class="card__content">
								  <div class="job-title">Front-end</div>
								  <div class="job-meta">
									<div class="company">Webingo</div>
									<div class="location">Kolkata</div>
								  </div>
						...
						<div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay="1.1s" style="visibility: visible; animation-delay: 1.1s; animation-name: fadeIn;">
								<div class="card " id="#card-0">
									...
									<div class="card-logo"><img src="images/white-logo.png"/></div>
									<div class="card__content">
									  <div class="job-title">Backend</div>
									  <div class="job-meta">
										<div class="company">Webingo</div>
										<div class="location">Kolkata</div>
									  </div>
							...
							<div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay="1.4s" style="visibility: visible; animation-delay: 1.4s; animation-name: fadeIn;">
								...
								<div class="card-logo"><img src="images/white-logo.png"/></div>
								<div class="card__content">
								  <div class="job-title">Web Design</div>
								  <div class="job-meta">
									<div class="company">Webingo</div>
									<div class="location">Kolkata</div>
								  </div>
							...
							<div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay="1.7s" style="visibility: visible; animation-delay: 1.7s; animation-name: fadeIn;">
								<div class="card " id="#card-0">
									...
									<div class="card-logo"><img src="images/white-logo.png"/></div>
									<div class="card__content">
									  <div class="job-title">Sale Executive </div>
									  <div class="job-meta">
										<div class="company">Webingo</div>
										<div class="location">Kolkata</div>
									  </div>
