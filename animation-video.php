...
<div class="row">
    ...
    <blockquote>
      <p>A minute of video is worth 1.8 million words</p>
      <footer>
...
<span class="text-radius  text-animation bg-b">GROW TRAFFIC &amp; INCREASE REVENUE</span>
	<h2>Why is it famous these days?</h2>
	<br>
<p style="text-align: justify">It makes us be able to tell stories and communicate emotions and ideas in a unique, easy-to-perceive way that both small children and adults can understand. Animation has helped connect people throughout the world in a way that sometimes writing and live-action films cannot. Animated video is an engaging instrument that can help you tell your story more comprehensively. 65% of people are visual learners, and 90% of the information transmitted to the brain is visual. Visual information is processed 60,000x faster than text. </p>
...
<img src="images/gif3d.gif" alt="image" class="img-fluid no-shadow">
</div>
</div>
</div>
</div>
...
<h2 class="mb30">Type of Animation Services</h2>
</div>
</div>
</div>
...
<h4>2D <br>Animation</h4>
<p >2-Dimensional descriptive or informative <br>videos.</p>
...
<h4>3D <br>Animation</h4>
<p>3-Dimensional descriptive or informative video which is greatly Interactive.</p>
...
<p>Physically drawn and illustrated story using a whiteboard.</p>
...
<p>Use of video to promote your brand or offering on digital channel.</p>
...
<p>Tell us  <span>video requirements</span></p>
<a href="#" class="btn-main bg-btn2 lnk">Inform us<i class="fas fa-chevron-right fa-icon"></i><span class="circle"></span></a>
</div>
</div>
</div>
</section>
					...
					<div class="container">
						<div class="row justify-content-center">
							<div class="col-lg-8">
								<div class="common-heading ptag">
									...
									<p class="mb30" style="color: #fff">
										Our work and happy clients speak for the top notch quality we deliver.</p>
								</div>
							</div>
						</div>
							...
							<div class="col-lg-4 col-sm-6 mt30  wow fadeIn" data-wow-delay=".2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeIn;">
								<div class="s-block wide-sblock">
									...
									<div class="s-block-content">
										...
										<p>Complete Solution digitally from the comfort of your home.</p>
									</div>
								</div>
							</div>
							...
							<div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay="1.7s" style="visibility: visible; animation-delay: 1.7s; animation-name: fadeIn;">
								<div class="s-block wide-sblock">
									...
									<div class="s-block-content">
										...
										<p style="margin-bottom:28px;">Our work speaks for the best quality we deliver.</p>
									</div>
								</div>
							</div>
						...
						<div class="-cta-btn mt70">
							<div class="free-cta-title v-center wow zoomInDown" data-wow-delay="1.8s" style="visibility: hidden; animation-delay: 1.8s; animation-name: none;">
								<p style="color: #fff">Let's create <span>something</span> Together</p>
          ...
          <div id="accordion" class="accordion">
            <div class="card-1">
              ...
              <div id="collapse-a" class="card-body collapse " aria-labelledby="faq1" data-parent="#accordion">
                <p>
					A typical 60 second explainer video takes 4-6 weeks to complete. If your project requires more complex animation, a larger collaborative team will be needed and will take at least 6-10 weeks to deliver. However, we also work on urgent projects when the need arises.</p>
              </div>
            </div>
           <div class="card-1 ">
              ...
              <div id="collapse-d" class="card-body collapse " aria-labelledby="faq4" data-parent="#accordion2">
				...
				You’ll get unlimited revisions for script development. We want to make sure your story is well crafted and is the best it can be before moving forward. All other stages; storyboard, voiceover, illustration, and animation come with as many revisions as necessary (within reasonable limits) to make sure the final product is good.</p>
              </div>
            </div>
          ...
          <div id="accordion2" class="accordion">
            <div class="card-1 ">
              ...
              <div id="collapse-4" class="card-body collapse " aria-labelledby="faq4" data-parent="#accordion2">
				...
				A typical explainer video should be at least 60 seconds, and 90 to 120 seconds for more complex subjects. Because each client and topic is different, the actual length will depend on several variables.</p>
              </div>
            </div>
			  <div class="card-1 ">
              <div class="card-header" id="faq4" style="background: navy">
              ...
              <div id="collapse-1" class="card-body collapse " aria-labelledby="faq4" data-parent="#accordion2">
                <p>
				WEBINGO is proud to create engaging content for every step of a buyer’s journey. From animated videos to explainer and educational videos, we offer premium content to help you achieve your business objectives. We offer the following types of videos. You can also get in touch with us so we can help you find out the right style of video for your business needs. </p>
				  <br>
				  <ul>
					  <li>➣ Explainer Videos. </li><br>
						 <li>➣ Product Demos.</li> <br>
						 <li>➣ Corporate Videos. </li><br>
						 <li>➣ Training Videos and Tutorials .</li><br>
						 <li>➣ Animated Stories. </li><br>
						 <li>➣ Sales Videos. </li><br>
						 <li>➣ Start-up Videos.</li><br>
						 <li>➣ and the list is endless.</li>
				  </ul>
              </div>
            </div>
